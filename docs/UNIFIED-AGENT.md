...
2026-09-06 最新部署：云端持久化已切换 PostgreSQL，工作台及官网问答已接入 WebSocket 增量推送。332 项 Windows 测试、数据库迁移逐行校验和真实线上两轮对话通过；版本、备份与证据见 [WebSocket / PostgreSQL 发布记录](../deployment/RELEASE-20260906-WS-POSTGRES.md)。以下较早测试数保留为历史阶段记录。
